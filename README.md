...
Finalmente se cuenta con **amIFam(address origin, uint256 trusterSBT)**. Esta función se utiliza fundamentalmente para poder realizar comprobaciones en el contrato cajaFuerteSalud, para ver si una dirección dada pertenece a la lista de direcciones de confianza de un token dado. 
